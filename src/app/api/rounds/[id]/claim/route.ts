...
import { ClaimResponse, ErrorResponse } from '@/types/responses';

export async function POST(request: NextRequest, { params }: { params: Promise<{ id: string }> }): Promise<NextResponse<ClaimResponse | ErrorResponse>> {
